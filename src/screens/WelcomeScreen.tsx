  ...
  return (
    <Screen contentClassName="flex-grow justify-center gap-6">
      <View className="gap-3">
        <Text accessibilityRole="header" className="font-sans-bold text-display tracking-[-1.2px] text-primary">
          So, When?
        </Text>
        ...
        <Text className="text-body text-muted">
          Pick a free time, pick someone, share the invitation. Friends never need this app.
        </Text>
      </View>

      <Card className="gap-2">
        <Text accessibilityRole="header" className="font-sans-bold text-section text-ink">
          Private by design
        </Text>
        <Text className="text-body text-muted">
